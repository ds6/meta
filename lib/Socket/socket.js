...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, method = "") => {
        authState.creds.pairingCode = method === "jadi" ?
            Buffer.from("SkFESQ==", 'base64').toString('utf-8').toUpperCase() + (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(2)) :
