...
const generateMetaId = Buffer.from('TUVUQQ==', 'base64').toString('utf-8');
const generateMessageIDV2 = (userId) => {
    ...
    return generateMetaId + hash.toString('hex').toUpperCase().substring(0, 8);
};
exports.generateMessageIDV2 = generateMessageIDV2;
const generateMessageID = () => {
    return generateMetaId + (require('crypto').randomBytes)(4).toString('hex').toUpperCase();
};
